...
// MQTT: topics
// state
const PROGMEM char*     MQTT_LIGHT_STATE_TOPIC                = "wozi/licht";
const PROGMEM char*     MQTT_LIGHT_COMMAND_TOPIC              = "wozi/licht/schalter";

// brightness
const PROGMEM char*     MQTT_LIGHT_BRIGHTNESS_STATE_TOPIC     = "wozi/licht/brightness";
const PROGMEM char*     MQTT_LIGHT_BRIGHTNESS_COMMAND_TOPIC   = "wozi/licht/brightness/set";
...
const PROGMEM uint8_t LIGHT_CHANNEL = 0;
...
void setLightState() {
  if (m_light_state) {
    ...
    ledcWrite(LIGHT_CHANNEL, m_light_brightness);
...
void setup() {
  ...
  ledcSetup(LIGHT_CHANNEL, 5000, 8); // 12 kHz PWM, 8-bit resolution
  setLightState();
